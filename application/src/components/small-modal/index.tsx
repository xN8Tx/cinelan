...
export const SmallModal = () => {
  ...
  return (
    <div
      className="absolute left-0 bottom-5 w-[calc(100%-1.25rem)]  h-12 data-[isactive=true]:opacity-100 opacity-0 translate-y-96 data-[isactive=true]:translate-y-0 transition-transform"
